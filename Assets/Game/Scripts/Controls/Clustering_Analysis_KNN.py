...
# 라벨 할당
cluster_to_label = {
    0: 'Evasion preference',
    1: 'Agressive preference',
    2: 'Kill preference',
    3: 'Exp preference'
}
...
# 모델 저장
model_file_path = "/Users/mylaptop/Documents/Study/Programming/Unity/Vamm_ML/Assets/Resources/My_K_Means_Model(KNN).pkl"
scaler_file_path = "/Users/mylaptop/Documents/Study/Programming/Unity/Vamm_ML/Assets/Resources/My_Scaler(KNN).pkl"
...
# 여기서는 군집 번호를 라벨로 사용합니다. 필요한 경우 의미 있는 라벨로 변환할 수 있습니다.
cluster_to_label = {
    0: 'Evasion preference',
    1: 'Agressive preference',
    2: 'Exp preference',
...
# K-Nearest Neighbors (KNN) 모델을 사용한 지도 학습
